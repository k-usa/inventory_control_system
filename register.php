        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <form action="datafile.php" method="post">
                    ...
                    <button type="submit"name="register" class="btn btn-primary btn-block mt-3">Submit</button>  
                </form>
                <p class="mt-3"><a href="login.php" class="text-muted text-decoration-none"><i class="fas fa-sign-in-alt"></i> Login</a></p>
            </div>
        </div>
